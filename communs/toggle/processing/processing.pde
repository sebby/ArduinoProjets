...
void setup() {
 ...
 port = new Serial(this, Serial.list()[0], 9600);  
  ...
  myTextlabelA = cp5.addTextlabel("label")
                    .setText("Allumer/eteindre 2 LEDs inversés")
                    .setPosition(10,10)
...
void shotDownLed(boolean LED){
 if(LED==true){
   port.write(255);
   myTextlabelB.setText("LED 1 allumé\nLED 2 éteint");
 }
else{
  port.write(0);
  
  myTextlabelB.setText("LED 1 éteint\nLED 2 allumé");
} 
}
